window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "cs_project_id": null,
    "account_id": 1830052,
    "account_signature": "4c08ef80560dd27c583012d023f66715c6265caec13e768c0e67f898eb2af83c"
};
...
! function() {
    ...
    var a, s = function() {
        ...
        l = function(e, t, n) {
            var r;
            c.loggedMetrics[e] = o(o({}, c.loggedMetrics[e]), {}, ((r = {})[t] = n || {}, r))
        },
        d = function(e) {
            if (!e) return "value";
        ...
        f = function(e) {
            ...
            return c.isDebugEnabled ? o(o(o({}, n), e.extraTags), c.genericTags) : n
        },
        g = function(e, t) {
            if (!a) return !1;
            var n = c.isMetricsEnabled || c.isDebugEnabled;
            return "lab" === e && (n = u.browser.inLab), "field" === e && (n = c.isFieldMetricsEnabled), t ? n && t.flush : n
        },
        h = function(e) {
            var t = !1,
            ...
            if (!1 === t) try {
                ...
                o.open("POST", r), o.timeout = 1e4, o.send(i)
            } catch (e) {}
        ...
        v = {
            ...
            start: function() {
                try {
                    ...
                    return c.genericTags = {
                        site_id: r
                    }, c.isDebugEnabled = Math.random() <= l.universalDebug || o.has("client_script.metrics.debug") && Math.random() <= l.debug, c.isMetricsEnabled = Math.random() <= l.metrics, c.isFieldMetricsEnabled = c.isMetricsEnabled && Math.random() <= l.fieldMetrics, a = new i(h, u.buffer.bufferSize, u.buffer.flushInterval), e
                } catch (e) {
            ...
            count: function(e, t) {
                ...
                try {
                    var u, l = d(r),
                        h = c.loggedMetrics[e],
                        v = 0;
                    if (n ? (v = (h && h[l] || 0) + (n.value || 1), c.loggedMetrics[e] = o(o({}, h), {}, ((u = {})[l] = null != n && n.flush ? 0 : v, u))) : v = 1, g(s, n)) {
                        var p = {
                            name: e,
                            type: "count",
                            value: v,
            ...
            timeIncr: function(e, t) {
                var n, r, i, o, a = t.tag,
                    ...
                    m = (n = e, {
                        tagName: r = d(a),
                        start: (o = (i = c.loggedMetrics[n]) && i[r] || {}).start,
                        total: o.total
                    }),
    ...
    var y = "https://voc.hotjar.com",
        j = [y, "https://voc.ew1-integration-1.hotjarians.net", "https://hj-engage-unmoderated-review.s3.eu-west-1.amazonaws.com"],
        _ = "hj-uut",
        S = {
            get: function() {
                var e = window.sessionStorage.getItem(_);
            ...
            set: function(e) {
                if (e) {
                    ...
                    window.sessionStorage.setItem(_, JSON.stringify(b(b({}, n), e)))
                }
            },
            clear: function() {
    ...
    var x, C = function() {
        var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            r = t.isCSQLite ? "t.contentsquare.net" : "t.cs.hotjar.io";
        ...
        if (i) {
            ...
            return o.type = "text/javascript", o.async = !0, o.src = "//".concat(r, "/uxa/").concat(i, ".js"), document.getElementsByTagName("head")[0].appendChild(o), o
        }
    };
    ...
    function I() {
        var e, t, n;
        p(), hj.metrics.start();
        var r, i, o, a, s, u, c, l, d, f, g, h, v = !(!window.CS_CONF || null === (e = window.CS_CONF.voc) || void 0 === e || !e.enabled),
            b = !(window.CS_CONF || null === (t = window.hjSiteSettings) || void 0 === t || null === (n = t.features) || void 0 === n || !n.includes("cs_lite"));
        if (v && window._uxa) window._uxa.push(["start:hotjar", hjSiteSettings]), window.hj.scriptLoaded = !0;
        else if (b) {
            var y = (u = (r = hjSiteSettings).suppress_all || r.suppress_text || (null === (i = r.suppress_all_on_specific_pages) || void 0 === i ? void 0 : i.length), c = function(e) {
                    var t, n, r, i, o, a = {
                        anonymisationMethod: null,
                        replayRecordingMaskedUrlRegex: null,
                        replayRecordingMaskedUrlRegexRules: null
                    };
                    if ((e.suppress_all || e.suppress_text) && (a.anonymisationMethod = m.replayRecordingMaskedUrlRegex, a.replayRecordingMaskedUrlRegex = ".*"), null !== (t = e.suppress_all_on_specific_pages) && void 0 !== t && t.length) {
                        a.anonymisationMethod = m.replayRecordingMaskedUrlRegexRules;
                        var s = (n = e.suppress_all_on_specific_pages, r = {
                            contains: w.CONTAIN,
                            regex: w.CONTAIN,
                            simple: w.CONTAIN,
                            ends_with: w.END,
                            exact: w.EXACT,
                            starts_with: w.START
                        }, i = [], o = Object.keys(r), n.forEach((function(e) {
                            if (e.pattern && o.includes(e.match_operation)) {
                                var t = {
                        ...
                        a.replayRecordingMaskedUrlRegexRules = s || null
                    }
                    return a
                }(r), l = c.anonymisationMethod, d = c.replayRecordingMaskedUrlRegex, f = c.replayRecordingMaskedUrlRegexRules, g = !(null === (o = _hjSettings) || void 0 === o || !o.environment || "live" === _hjSettings.environment), {
                    CS_CONF_BASE: {
                        ...
                        smbConfig: {
                            ...
                            useCSTC: !0,
                            useSentry: !0,
                            csLiteDomain: g ? "insights-integration.live.eks.hotjar.com" : "insights.hotjar.com"
                        },
                        hostnames: [window.location.hostname],
                        voc: null !== (a = r.polls) && void 0 !== a && a.length || T() ? {
                            enabled: 1,
                            siteId: r.site_id
                        } : {
                            enabled: 0
                        ...
                        implementations: (s = r, E(M, (h = s.state_change_listen_mode, "manual" === h ? [] : [{
                            template: {
                            ...
                            triggers: [{
                                name: "HistoryChange",
                                args: {
                                    listeners: "popstate, pushState, replaceState" + ("automatic_with_fragments" === h ? ", hashchange" : ""),
                                    useDebounce: "no",
                                    window: 400
                                }
                            }]
                        }]))),
                        recordTargetingRules: E(M, r.record_targeting_rules),
                        anonymisationMethod: l,
                        replayRecordingMaskedUrlRegex: d,
                        replayRecordingMaskedUrlRegexRules: f
                    },
            ...
            var r, i, o = new RegExp("bot|google|headless|baidu|bing|msn|duckduckbot|teoma|slurp|yandex|phantomjs|pingdom|ahrefsbot|facebook", "i"),
                a = (null === (r = window.navigator) || void 0 === r ? void 0 : r.userAgent) || "unknown";
            if (o.test(a)) return hj.metrics.count("session-rejection", {
                tag: {
                    reason: "bot"
                }
            ...
            if (s && !u) return hj.metrics.count("session-rejection", {
                tag: {
                    reason: "https"
                }
            ...
            window.hjBootstrap = function(e, t, n) {
                var r;
                window.hjBootstrapCalled = (window.hjBootstrapCalled || []).concat(n), window.hj && window.hj._init && !hj.features.isUchRouted() && (null === (r = hj._init) || void 0 === r || r._verifyInstallation())
            }, window.hjBootstrap(e, t, n), window.hjBootstrap.revision = "ac76e03";
            var c = window.document,
                l = c.head || c.getElementsByTagName("head")[0];
            hj.scriptDomain = e;
            var d = c.createElement("script");
            d.async = !0, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d)
        }, window.hjBootstrap("https://script.hotjar.com/", "modules.e762be2b6b709245aabb.js", "2803265")
    }
    window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.c882b60e63bb96a46f25.js"
        },
        SURVEY_BOOTSTRAPPER: {
    ...
    var A = null !== (x = hjSiteSettings.features) && void 0 !== x ? x : [];

    function N(e) {
        var t;
        null !== (t = window.hj) && void 0 !== t && t.metrics || (p(), hj.metrics.start()), hj.metrics.count("migration-error", {
            tag: {
                error: e
            }
        })
    ...
    function k() {
        window.UXAnalytics && N("csq-tag-already-loaded")
    }

    function U(e) {
        if (e) {
            var t = e.src.split("/uxa/")[0];
            document.addEventListener("securitypolicyviolation", (function e(n) {
                var r = n.effectiveDirective || n.violatedDirective || "";
                "enforce" !== n.disposition || 0 !== r.indexOf("script-src") && 0 !== r.indexOf("default-src") || ! function(e) {
                    if (0 !== e.indexOf(t)) return !1;
                    var n = e.slice(t.length);
                    return "" === n || "/" === n || 0 === n.indexOf("/uxa/")
                }(n.blockedURI) || (document.removeEventListener("securitypolicyviolation", e), N("csq-tag-blocked-by-csp"))
            })), e.addEventListener("error", (function() {
                return N("csq-tag-load-failed")
            }), {
                once: !0
            })
        }
    }
    A.indexOf("one_app_tag") > -1 ? (k(), U(C())) : A.indexOf("one_app_tag_dc") > -1 ? (I(), k(), U(C())) : I()
}();