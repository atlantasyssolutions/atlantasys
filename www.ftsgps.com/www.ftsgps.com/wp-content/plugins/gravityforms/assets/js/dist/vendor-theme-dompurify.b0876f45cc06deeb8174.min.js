        ...
        6308: function(e) {
            e.exports = function() {
                ...
                const u = N(Array.prototype.forEach),
                    ...
                    E = N(Object.prototype.hasOwnProperty),
                ...
                const L = i(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                    ...
                    k = i(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]),
                ...
                function J() {
                    ...
                    const n = e => J(e);
                    if (n.version = "3.0.11", n.removed = [], !t || !t.document || 9 !== t.document.nodeType) return n.isSupported = !1, n;
                    let {
                        document: o
                    } = t;
                    const r = o,
                    ...
                    let le = {};
                    n.isSupported = "function" == typeof e && "function" == typeof Q && ne && void 0 !== ne.createHTMLDocument;
                    const {
                        MUSTACHE_EXPR: ce,
                        ERB_EXPR: se,
                        TMPLIT_EXPR: ue,
                    ...
                    let He = !0,
                        ...
                        ze = {},
                        Be = null;
                    const We = S({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
                    let Ge = null;
                    const Ye = S({}, ["audio", "video", "img", "source", "image", "track"]);
                    let je = null;
                    const qe = S({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
                    ...
                    let Ve = Ke,
                        Ze = !1,
                        Je = null;
                    const Qe = S({}, [Xe, $e, Ke], d);
                    let et = null;
                    const tt = ["application/xhtml+xml", "text/html"],
                        nt = "text/html";
                    let ot = null,
                        rt = null;
                    const it = o.createElement("form"),
                        at = function(e) {
                        ...
                        lt = function() {
                            ...
                            if (!rt || rt !== e) {
                                ...
                                } else void 0 === ee && (ee = Z(W, a)), null !== ee && "string" == typeof te && (te = ee.createHTML(""));
                                i && i(e), rt = e
                            }
                        },
                        ct = S({}, ["mi", "mo", "mn", "ms", "mtext"]),
                        st = S({}, ["foreignobject", "desc", "title", "annotation-xml"]),
                        ut = S({}, ["title", "style", "font", "a", "script"]),
                        mt = S({}, [...D, ...k, ...O]),
                        pt = S({}, [...v, ...x]),
                        ft = function(e) {
                            let t = Q(e);
                        ...
                        gt = function(e) {
                            ...
                            "application/xhtml+xml" === et && Ve === Ke && (e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>");
                            const r = ee ? ee.createHTML(e) : e;
                            if (Ve === Ke) try {
                                t = (new B).parseFromString(r, et)
                            } catch (e) {}
                            if (!t || !t.documentElement) {
                                t = ne.createDocument(Ve, "template", null);
                                try {
                                    t.documentElement.innerHTML = Ze ? te : r
                                } catch (e) {}
                            }
                            const i = t.body || t.documentElement;
                            return e && n && i.insertBefore(o.createTextNode(n), i.childNodes[0] || null), Ve === Ke ? ie.call(t, De ? "html" : "body")[0] : De ? t.documentElement : i
                        },
                        Tt = function(e) {
                            return oe.call(e.ownerDocument || e, e, R.SHOW_ELEMENT | R.SHOW_COMMENT | R.SHOW_TEXT | R.SHOW_PROCESSING_INSTRUCTION | R.SHOW_CDATA_SECTION, null)
                        },
                        yt = function(e) {
                        ...
                        _t = function(e) {
                            let t = null;
                            if (At("beforeSanitizeElements", e, null), yt(e)) return dt(e), !0;
                            const o = ot(e.nodeName);
                            if (At("uponSanitizeElement", e, {
                                    tagName: o,
                                    allowedTags: Te
                                }), e.hasChildNodes() && !Et(e.firstElementChild) && A(/<[/\w]/g, e.innerHTML) && A(/<[/\w]/g, e.textContent)) return dt(e), !0;
                            ...
                            if (!Te[o] || Ne[o]) {
                                ...
                                if (He && !Be[o]) {
                                    const t = Q(e) || e.parentNode,
                                        n = $(e) || e.childNodes;
                                    if (n && t)
                                        for (let o = n.length - 1; o >= 0; --o) t.insertBefore(j(n[o], !0), q(e))
                                }
                                return dt(e), !0
                            }
                            return e instanceof b && !ft(e) ? (dt(e), !0) : "noscript" !== o && "noembed" !== o && "noframes" !== o || !A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (Le && 3 === e.nodeType && (t = e.textContent, u([ce, se, ue], e => {
                                t = g(t, e, " ")
                            }), e.textContent !== t && (p(n.removed, {
                                element: e.cloneNode()
                            }), e.textContent = t)), At("afterSanitizeElements", e, null), !1) : (dt(e), !0)
                        },
                        Nt = function(e, t, n) {
                            if (Me && ("id" === t || "name" === t) && (n in o || n in it)) return !1;
                            if (Re && !be[t] && A(me, t));
                            else if (Se && A(pe, t));
                            else if (!Ee[t] || be[t]) {
                                if (!(bt(e) && (_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, e) || _e.tagNameCheck instanceof Function && _e.tagNameCheck(e)) && (_e.attributeNameCheck instanceof RegExp && A(_e.attributeNameCheck, t) || _e.attributeNameCheck instanceof Function && _e.attributeNameCheck(t)) || "is" === t && _e.allowCustomizedBuiltInElements && (_e.tagNameCheck instanceof RegExp && A(_e.tagNameCheck, n) || _e.tagNameCheck instanceof Function && _e.tagNameCheck(n)))) return !1
                            } else if (je[t]);
                            else if (A(ge, g(n, de, "")));
                            else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== T(n, "data:") || !Ge[e])
                                if (we && !A(fe, g(n, de, "")));
                                else if (n) return !1;
                            return !0
                        },
                        bt = function(e) {
                            return "annotation-xml" !== e && h(e, he)
                        },
                        St = function(e) {
                            ...
                            for (; r--;) {
                                const i = t[r],
                                    ...
                                    s = ot(a);
                                let p = "value" === a ? c : y(c);
                                if (o.attrName = s, o.attrValue = p, o.keepAttr = !0, o.forceKeepAttr = void 0, At("uponSanitizeAttribute", e, o), p = o.attrValue, o.forceKeepAttr) continue;
                                if (ht(a, e), !o.keepAttr) continue;
                                if (!Ce && A(/\/>/i, p)) {
                                    ht(a, e);
                                    continue
                                }
                                ...
                                const f = ot(e.nodeName);
                                if (Nt(f, s, p)) {
                                    if (!Ue || "id" !== s && "name" !== s || (ht(a, e), p = Pe + p), ee && "object" == typeof W && "function" == typeof W.getAttributeType)
                                        if (l);
                                        else switch (W.getAttributeType(f, s)) {
                                            case "TrustedHTML":
                                                p = ee.createHTML(p);
                                                break;
                                            case "TrustedScriptURL":
                                                p = ee.createScriptURL(p)
                                        }
                                    try {
                                        l ? e.setAttributeNS(l, a, p) : e.setAttribute(a, p), m(n.removed)
                                    } catch (e) {}
                                }
                            }
                        ...
                        Rt = function e(t) {
                            let n = null;
                            const o = Tt(t);
                            for (At("beforeSanitizeShadowDOM", t, null); n = o.nextNode();) At("uponSanitizeShadowNode", n, null), _t(n) || (n.content instanceof c && e(n.content), St(n));
                    ...
                    return n.sanitize = function(e) {
                        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            ...
                            a = null,
                            l = null;
                        if (Ze = !e, Ze && (e = "\x3c!--\x3e"), "string" != typeof e && !Et(e)) {
                        ...
                        if (ke || lt(t), n.removed = [], "string" == typeof e && (Fe = !1), Fe) {
                            if (e.nodeName) {
                                const t = ot(e.nodeName);
                                if (!Te[t] || Ne[t]) throw _("root node is forbidden and cannot be sanitized in-place")
                            }
                        } else if (e instanceof N) o = gt("\x3c!----\x3e"), i = o.ownerDocument.importNode(e, !0), 1 === i.nodeType && "BODY" === i.nodeName || "HTML" === i.nodeName ? o = i : o.appendChild(i);
                        else {
                            if (!ve && !Le && !De && -1 === e.indexOf("<")) return ee && Ie ? ee.createHTML(e) : e;
                            if (o = gt(e), !o) return ve ? null : Ie ? te : ""
                        }
                        o && Oe && dt(o.firstChild);
                        const s = Tt(Fe ? e : o);
                        for (; a = s.nextNode();) _t(a) || (a.content instanceof c && Rt(a.content), St(a));
                        if (Fe) return e;
                        if (ve) {
                            if (xe)
                                for (l = re.call(o.ownerDocument); o.firstChild;) l.appendChild(o.firstChild);
                            else l = o;
                            return (Ee.shadowroot || Ee.shadowrootmode) && (l = ae.call(r, l, !0)), l
                        }
                        let m = De ? o.outerHTML : o.innerHTML;
                        return De && Te["!doctype"] && o.ownerDocument && o.ownerDocument.doctype && o.ownerDocument.doctype.name && A(X, o.ownerDocument.doctype.name) && (m = "<!DOCTYPE " + o.ownerDocument.doctype.name + ">\n" + m), Le && u([ce, se, ue], e => {
                            m = g(m, e, " ")
                        }), ee && Ie ? ee.createHTML(m) : m
                    }, n.setConfig = function() {
                        lt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}), ke = !0
