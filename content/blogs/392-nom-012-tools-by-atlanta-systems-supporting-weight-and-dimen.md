# NOM-012 Tools by Atlanta Systems Supporting Weight and Dimension Data on Monterrey Runs

* **Slug**: `nom-012-tools-by-atlanta-systems-supporting-weight-and-dimension-data-on-monterrey-runs`
...
* **[Related Technical Deep-Dive 1](/blog/399-smart-parking-by-atlanta-systems-using-live-gps-for-new-york)**: Engineering analysis and hardware setup protocol.
* **[Related Technical Deep-Dive 2](/blog/409-ble-5-0-beacons-by-atlanta-systems-enabling-precise-gdp-mapp)**: Diagnostic algorithm analysis and enterprise portal integration.
* **[Related Technical Deep-Dive 3](/blog/42-4g-lte-m-dual-sim-muscat-sohar-port)**: Regulatory compliance framework and field deployment guidelines.
