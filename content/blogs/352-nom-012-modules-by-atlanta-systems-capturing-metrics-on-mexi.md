# NOM-012 Modules by Atlanta Systems Capturing Metrics on Mexico City Distribution Runs

* **Slug**: `nom-012-modules-by-atlanta-systems-capturing-metrics-on-mexico-city-distribution-runs`
...
* **[Related Technical Deep-Dive 1](/blog/359-smart-parking-geofencing-by-atlanta-systems-improving-utiliz)**: Engineering analysis and hardware setup protocol.
* **[Related Technical Deep-Dive 2](/blog/369-esim-hardware-from-atlanta-systems-supporting-continuous-roa)**: Diagnostic algorithm analysis and enterprise portal integration.
* **[Related Technical Deep-Dive 3](/blog/38-driver-eco-scoring-rotterdam-a15)**: Regulatory compliance framework and field deployment guidelines.
