        ...
        return (
          <button
            ...
            style={{
              ...
              padding: '0 10px',
              borderRadius: '8px',
              border: page === currentPage ? '1px solid #0169A9' : '1px solid #CBD5E1',
              background: page === currentPage ? '#0169A9' : '#FFFFFF',
              color: page === currentPage ? '#FFFFFF' : '#334155',
              boxShadow: page === currentPage ? '0 2px 8px rgba(1, 105, 169, 0.35)' : 'none',
              fontWeight: '700',
              fontSize: '0.875rem',
              cursor: 'pointer',
